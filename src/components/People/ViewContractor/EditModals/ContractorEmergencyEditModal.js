...
const ContractorEmergencyEditModal = ({
  ...
  useEffect(() => {
    if (contractorData && contractorData.emergencyInfo) {
      setEmergencyPhone(contractorData.emergencyInfo.phone);
      setFieldsValue({
        emergencyFullName: contractorData.emergencyInfo.fullName,
        emergencyRelationship: contractorData.emergencyInfo.relation,
        emergencyPhone: contractorData.emergencyInfo.phone,
        emergencyEmail: contractorData.emergencyInfo.email,
      });
    }
