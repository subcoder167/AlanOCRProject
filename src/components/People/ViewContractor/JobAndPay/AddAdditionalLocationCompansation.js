...
import { Form, Modal, DatePicker, Radio, Row, Col, Input, Select, Button } from "antd";
    ...
    const handleSubmit = (e) => {
        ...
        props.form.validateFields(async (err, values) => {
            ...
            if (!err) {
                ...
                //   handleCancel();
                // }
                console.log("set additional compensation values", values)
                values.employmentClass = wageType
                onFinish({ ...values });
                // setFormTab("3");
            } else {
                console.log(err)
